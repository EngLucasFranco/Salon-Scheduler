...
export default function FluxoCaixa() {
  ...
  const [carregando, setCarregando] = useState(true); const [salvando, setSalvando] = useState(false); const [erro, setErro] = useState(''); const [mensagem, setMensagem] = useState('');
  ...
  return <div className="pagina fluxo-caixa">
    ...
    <div className="caixa-resumo"><span>Recebido em {data.split('-').reverse().join('/')}</span><strong>{moeda(totalDia)}</strong></div>
